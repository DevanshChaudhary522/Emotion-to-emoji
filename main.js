//https://teachablemachine.withgoogle.com/models/NUdfSUWAb/
prediction_1 = "";
prediction_2 = "";
...
Webcam.set({
  ...
  classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/NUdfSUWAb/model.json',modelLoaded);
   ...
   function gotResult(error,results) {
      if (error){
        ...
        if (results[0].label=="Laugh"){
            document.getElementById("update_emoji").innerHTML="&#128516";
